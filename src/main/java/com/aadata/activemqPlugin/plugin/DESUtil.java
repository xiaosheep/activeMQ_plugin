...
public class DESUtil {
	...
	private static final String PASSWORD= "HYAADATA2.0";
	 ...
	 * @return
	 */
	public static String encryptHY(String data) {
	 ...
	 * @return
	 */
	public static String decryptHY(String data) {
		return decrypt(PASSWORD,data);
	}
	
	
	public static void main(String[] args) {
		String jiami=DESUtil.encryptHY("admin");
		System.out.println(DESUtil.encryptHY("管理员"));
		System.out.println(jiami);
		System.out.println(DESUtil.decryptHY(jiami));
		
		System.out.println(DESUtil.decryptHY("管理员"));
	}
